...
const strings = {
	"es": {
		...
		"Enable/disable instant teleport": "Activar/desactivar teletransporte instantáneo",
		"Enable/disable BAM-HP-Bar feature": "Activar/desactivar característica BAM-HP-Bar",
		"Remove marker from NPC": "Quitar marcador de NPC",
		"Display the spawn times of Mystery Merchants": "Muestra los tiempos de aparición de Mystery Merchants",
		"Display Mystery Merchants locations of current zone": "Mostrar ubicaciones de Mystery Merchants de la zona actual",
		"Search for Mystery Merchants in current zone": "Buscar Mystery Merchants en la zona actual",
		"Display the spawn times of World Bosses": "Muestra los tiempos de aparición de World Bosses",
		"Display World Bosses locations of current zone": "Mostrar ubicaciones de World Bosses de la zona actual",
		"Search for World Bosses in current zone": "Buscar World Bosses en la zona actual",
		"Display the spawn times of Raid Bosses": "Muestra los tiempos de generación de los Raid Bosses",
		"Display Raid Bosses locations of current zone": "Mostrar ubicaciones de Raid Bosses de la zona actual",
		"Search for Raid Bosses in current zone": "Buscar Raid Bosses en la zona actual",
		"Stop search": "Detener la búsqueda",
		"Teleport to specified location": "Teletransportarse a la ubicación especificada",
		"Use command": "Usar comando",
		"or racial skill for teleport there": "o habilidad racial para teletransportarse allí",
		"Enabled": "Activado",
		"Disabled": "Desactivado",
		"Alert messages": "Advertencias",
		"Notice messages": "Notificaciones",
		"Party messages": "Mensajes para el grupo",
		"Spawn messages": "Mensajes de generación",
		"Instant teleport": "Teletransporte instantáneo",
		"BAM-HP-Bar feature": "Característica BAM-HP-Bar",
		...
		"Scan stopped": "Escaneo detenido",
		"No positions for this zone": "No hay posiciones para esta zona",
		"NPC is not found": "NPC no se encuentra",
		"channel": "canal",
		"no data": "no hay datos",
		"spawned at": "apareció en",
		"last": "último",
		"next": "siguiente"
	}
};
